    ...
    <section class="ftco-search">
    	<div class="container">
	    	<div class="row">
					...
					<form action="search.php" method="Get" name="categoryfrom" onsubmit="return validatefrom()" enctype="multipart/form-data">
  <div class="form-group" >
      

    <button type="submit" name="Search" class="btn btn-outline-primary md-3" style="display: flex;width: 100%;">
       <input type="search"  name="Location" class="form-control" id="Location" placeholder="Choose your location" required style="border-radius: 100px;width: 100%;"> 
        </button>
</div>
</form>
					</div>
          ...
          while($row = mysqli_fetch_assoc($result)){  ?>
    			<div class="col-md-4 ftco-animate">
    				<div class="properties">
    					...
    					<a href="single.php?single=<?php echo $row['a130']; ?>"  class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?php echo "https://tlgniwas.com/". $row['thumall'];?>);">
    					...
    					<div class="text p-3">
    						...
    						<?php }else { ?>
    								    						<span class="status sale">Sale</span><?php }?>
    						...
    						<div class="d-flex">
	    						...
	    						<div class="two" style="padding-left: initial;">
	    							<span class="price"><?php echo "Rs:".$row['Tsa'];?> </span>
    							</div>
    						</div>
    						    						     <?php if($row['a150'] == "Rent" ){ ?>
